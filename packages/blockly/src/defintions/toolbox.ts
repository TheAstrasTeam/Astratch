...
const getToolbox = (): Blockly.utils.toolbox.ToolboxInfo => {
    return {
        ...
        contents: [
            {
                kind: 'category',
                id: 'entity',
                name: i18next.t('blocks:category.entity'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.transform'),
                        colour: BlocksColor.position.primary,
                        contents: [
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.position'),
                            ...
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.scale'),
                            ...
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.direction'),
                            ...
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.layer'),
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.appearance'),
                        colour: BlocksColor.Images.primary,
                        contents: [
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.images'),
                            ...
                            {
                                kind: 'category',
                                name: i18next.t('blocks:category.effects'),
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.collision'),
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.lifecycle'),
            ...
            },
            {
                kind: 'category',
                id: 'audio',
                name: i18next.t('blocks:category.audio'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.play'),
                        ...
                        contents: [
                            {
                                ...
                                inputs: {
                                    AUDIO: txt(i18next.t('blocks:audio.play.exampleAudioName')),
                                    NAME: txt(i18next.t('blocks:audio.play.exampleName')),
                    ...
                    },
                    {
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: { NAME: txt(i18next.t('blocks:audio.play.exampleName')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
            ...
            },
            {
                kind: 'category',
                id: 'resources',
                name: i18next.t('blocks:category.resources'),
                contents: [
                    {
                        gap: 12,
                        kind: 'block',
                    ...
                    },
                    {
                        ...
                        inputs: { NAME: txt(i18next.t('blocks:example.resource')) },
                    },
                    {
                        gap: 12,
                        kind: 'block',
                    ...
                    },
                    {
                        ...
                        inputs: {
                            OLD_NAME: txt(i18next.t('blocks:example.resource')),
                            NEW_NAME: txt(i18next.t('blocks:example.newResource')),
                        },
                    },
                    {
                        gap: 12,
            ...
            },
            {
                kind: 'category',
                id: 'events',
                name: i18next.t('blocks:category.events'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.broadcast'),
                        ...
                        contents: [
                            {
                                ...
                                inputs: {
                                    CHANNEL: txt(i18next.t('blocks:example.channel')),
                                    DATA: txt(i18next.t('blocks:example.data')),
                                },
                            },
                            {
                                gap: 12,
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.time'),
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: { NAME: txt(i18next.t('blocks:example.timer')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    NAME: txt(i18next.t('blocks:example.timer')),
                                    DURATION: numWhole(1),
                                },
                            },
                        ],
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.input'),
            ...
            },
            {
                kind: 'category',
                id: 'control',
                name: i18next.t('blocks:category.control'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.flow'),
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.condition'),
                        ...
                        contents: [
                            ...
                            sep(),
                            {
                                ...
                                inputs: { VALUE: txt(i18next.t('blocks:example.value')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                                type: OPCODES.CONTROL_MATCH_CASE,
                                inputs: { VALUE: txt(i18next.t('blocks:example.case')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.loop'),
            ...
            },
            {
                kind: 'category',
                id: 'operator',
                name: i18next.t('blocks:category.operator'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.math'),
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.logic'),
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    ...
                                    THEN: txt(i18next.t('blocks:example.value')),
                                    ELSE: txt(i18next.t('blocks:example.value')),
                                },
                            },
                        ],
                    },
            ...
            },
            {
                kind: 'category',
                id: 'data',
                name: i18next.t('blocks:category.data'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.variable'),
                        colour: BlocksColor.data.primary,
                        custom: OPCODES.DATA_CATEGORY,
                    },
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.string'),
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    TEXT: txt(i18next.t('blocks:example.text')),
                                    START: numWhole(1),
                                    END: numWhole(1),
                                },
                            },
                            {
                                ...
                                inputs: { TEXT: txt(i18next.t('blocks:example.text')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                                ...
                                inputs: {
                                    TEXT: txt(i18next.t('blocks:example.text')),
                                    SEARCH: txt(i18next.t('blocks:example.string')),
                                },
                            },
                            {
                                gap: 12,
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    TEXT: txt(i18next.t('blocks:example.text')),
                                    SEARCH: txt(i18next.t('blocks:example.string')),
                                    REPLACEMENT: txt(i18next.t('blocks:example.value')),
                                },
                            },
                        ],
                    },
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.array'),
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: { VALUE: txt(i18next.t('blocks:example.item')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                            ...
                            },
                            {
                                ...
                                inputs: { FILTER: txt(i18next.t('blocks:example.condition')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    INDEX: numWhole(1),
                                    VALUE: txt(i18next.t('blocks:example.item')),
                                },
                            },
                            {
                                gap: 12,
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.object'),
                        colour: BlocksColor.data.secondary,
                        contents: [
                            {
                                gap: 12,
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    KEY: txt(i18next.t('blocks:example.key')),
                                    VALUE: txt(i18next.t('blocks:example.value')),
                                },
                            },
                            {
                                gap: 12,
                                ...
                                inputs: { KEY: txt(i18next.t('blocks:example.key')) },
                            },
                            {
                                gap: 12,
                                kind: 'block',
                    ...
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.type'),
                        colour: BlocksColor.data.tertiary,
                        contents: [
                            {
                                gap: 12,
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    TYPE: txt(i18next.t('blocks:example.string')),
                                },
                            },
                            {
                                gap: 12,
            ...
            },
            {
                kind: 'category',
                id: 'function',
                name: i18next.t('blocks:category.function'),
                custom: OPCODES.FUNCTION_CATEGORY,
            },
            {
                kind: 'category',
                id: 'canvas',
                name: i18next.t('blocks:category.canvas'),
                contents: [
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.canvas.pen'),
                        ...
                        contents: [
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    IMG: txt(i18next.t('blocks:example.resource')),
                                    X: num(100),
                                    Y: num(-100),
                                    SIZE: num(50),
                                    ANGLE: numAngle(90),
                            ...
                            sep(),
                            {
                                ...
                                inputs: {
                                    TXT: txt(i18next.t('blocks:example.text')),
                                    X: num(100),
                                    Y: num(-100),
                            ...
                            },
                            {
                                ...
                                inputs: {
                                    FONT: txt(i18next.t('blocks:example.textfont')),
                                },
                            },
                        ],
                    },
                    {
                        kind: 'category',
                        name: i18next.t('blocks:category.canvas.render'),
                        ...
                        contents: [
                            {
                                ...
                                inputs: {
                                    NAME: txt(i18next.t('blocks:example.canvasData')),
                                },
                            },
                            {
                                gap: 12,
            ...
            },
            {
                kind: 'category',
                id: 'debug',
                name: i18next.t('blocks:category.debug'),
                contents: [
                    {
                        gap: 12,
                        kind: 'block',
                        ...
                        inputs: {
                            ...
                            MESSAGE: txt(i18next.t('blocks:example.message')),
                        },
                    },
                    {
                        gap: 12,
                        ...
                        inputs: { MESSAGE: txt(i18next.t('blocks:example.error')) },
                    },
                    {
                        gap: 12,
                        kind: 'block',
