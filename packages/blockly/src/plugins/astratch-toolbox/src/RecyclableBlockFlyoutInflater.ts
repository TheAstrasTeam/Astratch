...
export class RecyclableBlockFlyoutInflater extends Blockly.BlockFlyoutInflater {
     ...
     */
    private getTypeFromDefinition(blockDefinition: Blockly.utils.toolbox.BlockInfo): string {
    ...
    override disposeItem(item: Blockly.FlyoutItem) {
        ...
        if (element instanceof Blockly.BlockSvg && this.blockIsRecyclable(element)) {
