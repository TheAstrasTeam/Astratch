...
import {
    FieldGridDropdown,
    type FieldGridDropdownConfig,
    type FieldGridDropdownFromJsonConfig,
} from '../../field-grid-dropdown/src';
 ...
 */
function makeSwatches(colours: string[], titles?: string[]): Blockly.MenuOption[] {
