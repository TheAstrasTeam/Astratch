...
export class FieldColourHsvSliders extends FieldColour {
     ...
     */
    private static createLabelInContainer(name: string, container: HTMLElement): HTMLSpanElement {
     ...
     */
    private static hsvToHex(hue: number, saturation: number, brightness: number): string {
    ...
    private onSliderChange(event?: Event): void {
        ...
        const saturation: number =
            parseFloat(this.saturationSlider.value) / FieldColourHsvSliders.SATURATION_SLIDER_MAX;
        const brightness: number =
            parseFloat(this.brightnessSlider.value) / FieldColourHsvSliders.BRIGHTNESS_SLIDER_MAX;
        this.setIntermediateValue(FieldColourHsvSliders.hsvToHex(hue, saturation, brightness));
        this.renderSliders();
    }
    ...
    private renderSliders(): void {
        ...
        const h: number = parseFloat(this.hueSlider.value) / FieldColourHsvSliders.HUE_SLIDER_MAX;
        const s: number =
            parseFloat(this.saturationSlider.value) / FieldColourHsvSliders.SATURATION_SLIDER_MAX;
        const v: number =
            parseFloat(this.brightnessSlider.value) / FieldColourHsvSliders.BRIGHTNESS_SLIDER_MAX;
        ...
        saturationGradient +=
            FieldColourHsvSliders.hsvToHex(h, 0, v) + ` ${FieldColourHsvSliders.THUMB_RADIUS}px, `;
        saturationGradient +=
        ...
        brightnessGradient +=
            FieldColourHsvSliders.hsvToHex(h, s, 0) + ` ${FieldColourHsvSliders.THUMB_RADIUS}px, `;
        brightnessGradient +=
