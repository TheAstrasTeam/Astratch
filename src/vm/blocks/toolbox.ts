        ...
        contents: [
            {
                ...
                contents: [
                    { gap: 12, kind: 'block', type: OPCODE.motion_movesteps, inputs: { STEPS: num(10) } },
                    { gap: 12, kind: 'block', type: OPCODE.motion_turnright, inputs: { DEGREES: num(15) } },
                    { gap: 12, kind: 'block', type: OPCODE.motion_turnleft, inputs: { DEGREES: num(15) } },
                    sep(),
                    {
                        gap: 12, kind: 'block',
                    ...
                    { gap: 12, kind: 'block', type: OPCODE.motion_gotoxy, inputs: { X: num(0), Y: num(0) } },
                    {
                        gap: 12, kind: 'block',
                    ...
                    sep(),
                    { gap: 12, kind: 'block', type: OPCODE.motion_changexby, inputs: { DX: num(10) } },
                    { gap: 12, kind: 'block', type: OPCODE.motion_setx, inputs: { X: num(0) } },
                    { gap: 12, kind: 'block', type: OPCODE.motion_changeyby, inputs: { DY: num(10) } },
            ...
            },
            {
                ...
                contents: [
                    ...
                    sep(),
                    { gap: 12, kind: 'block', type: OPCODE.looks_changesizeby, inputs: { CHANGE: num(10) } },
                    { gap: 12, kind: 'block', type: OPCODE.looks_setsizeto, inputs: { SIZE: num(100) } },
                    sep(),
                    {
                        gap: 12, kind: 'block',
                    ...
                    { gap: 12, kind: 'block', type: OPCODE.looks_seteffectto, inputs: { VALUE: num(0) } },
            ...
            },
            {
                ...
                contents: [
                    ...
                    { gap: 12, kind: 'block', type: OPCODE.sound_seteffectto, inputs: { VALUE: num(100) } },
                    ...
                    { gap: 12, kind: 'block', type: OPCODE.sound_setvolumeto, inputs: { VOLUME: num(100) } },
            ...
            },
            {
                ...
                contents: [
                    { gap: 12, kind: 'block', type: OPCODE.control_wait, inputs: { DURATION: numPos(1) } },
                    sep(),
                    { gap: 12, kind: 'block', type: OPCODE.control_repeat, inputs: { TIMES: numWhole(10) } },
            ...
            },
            {
                ...
                contents: [
                    ...
                    { gap: 12, kind: 'block', type: OPCODE.operator_round, inputs: { NUM: num('') } },
                    sep(),
                    { gap: 12, kind: 'block', type: OPCODE.operator_mathop, inputs: { NUM: num('') } },
                ],
            },
            {
                kind: 'category',
