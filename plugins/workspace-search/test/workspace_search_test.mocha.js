...
suite('WorkspaceSearch', function () {
    ...
    function isBlockHighlighted(block) {
        ...
        return (' ' + classes + ' ').indexOf(' blockly-ws-search-highlight ') !== -1;
    }
    /**
    ...
    setup(function () {
        this.jsdomCleanup = require('jsdom-global')('<!DOCTYPE html><div id="blocklyDiv"></div>');
    ...
    suite('createBtn()', function () {
        test('Buttons have type button', function () {
            this.workspaceSearch.init();
            const nextBtn = document.querySelector('button.blockly-ws-search-next-btn');
            const previousBtn = document.querySelector('button.blockly-ws-search-previous-btn');
            const closeBtn = document.querySelector('button.blockly-ws-search-close-btn');
    ...
    suite('searchAndHighlight()', function () {
        ...
        setup(function () {
            ...
            this.testStatementBlockWithInput = this.workspace.newBlock('test_statement_block');
        ...
        test('Match all blocks', function () {
            ...
            assertEqualsSearchGroup(this.blocks, this.workspaceSearch.blocks, expectedBlocks);
