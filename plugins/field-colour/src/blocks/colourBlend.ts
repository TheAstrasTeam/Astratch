...
export function toJavascript(
    ...
    const colour1 = generator.valueToCode(block, 'COLOUR1', JavascriptOrder.NONE) || "'#000000'";
    const colour2 = generator.valueToCode(block, 'COLOUR2', JavascriptOrder.NONE) || "'#000000'";
...
export function toDart(block: Block, generator: DartGenerator): [string, DartOrder] {
    // Blend two colours together.
    const colour1 = generator.valueToCode(block, 'COLOUR1', DartOrder.NONE) || "'#000000'";
    const colour2 = generator.valueToCode(block, 'COLOUR2', DartOrder.NONE) || "'#000000'";
    const ratio = generator.valueToCode(block, 'RATIO', DartOrder.NONE) || 0.5;

    // TODO(#7600): find better approach than casting to any to override
    // CodeGenerator declaring .definitions protected.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (generator as any).definitions_['import_dart_math'] = "import 'dart:math' as Math;";
    const functionName = generator.provideFunction_(
        'colour_blend',
        `
...
`,
    ...
    const colour1 = generator.valueToCode(block, 'COLOUR1', LuaOrder.NONE) || "'#000000'";
    const colour2 = generator.valueToCode(block, 'COLOUR2', LuaOrder.NONE) || "'#000000'";
...
export function toPhp(block: Block, generator: PhpGenerator): [string, PhpOrder] {
    // Blend two colours together.
    const colour1 = generator.valueToCode(block, 'COLOUR1', PhpOrder.NONE) || "'#000000'";
    const colour2 = generator.valueToCode(block, 'COLOUR2', PhpOrder.NONE) || "'#000000'";
...
`,
    ...
    const colour1 = generator.valueToCode(block, 'COLOUR1', PythonOrder.NONE) || "'#000000'";
    const colour2 = generator.valueToCode(block, 'COLOUR2', PythonOrder.NONE) || "'#000000'";
    const ratio = generator.valueToCode(block, 'RATIO', PythonOrder.NONE) || 0;
    const code = `${functionName}(${colour1}, ${colour2}, ${ratio})`;
    return [code, PythonOrder.FUNCTION_CALL];
}

const definitionsDict = BlocklyCommon.createBlockDefinitionsFromJsonArray([jsonDefinition]);
